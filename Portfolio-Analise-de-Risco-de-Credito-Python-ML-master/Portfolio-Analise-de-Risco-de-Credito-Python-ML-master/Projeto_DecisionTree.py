...
#Criando modelo baseado em árvore de descisão

from sklearn.tree import DecisionTreeClassifier
modelo_arvore=DecisionTreeClassifier()

modelo_arvore.fit(X_treinamento2,Y_treinamento)
previsao = modelo_arvore.predict(X_teste2)
...
#Neste modelo de árvore de descisão consegui um resultado de 66,66% de acerto
#sem a seleção de atributos e com a seleção o resultado subiu para 67,33%, porém ainda 
#inferior a 75% necessário.
