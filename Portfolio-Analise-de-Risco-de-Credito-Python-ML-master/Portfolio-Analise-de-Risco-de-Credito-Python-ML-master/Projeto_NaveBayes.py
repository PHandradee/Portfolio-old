...
X_teste,X_treinamento,Y_teste,Y_treinamento = train_test_split(X,Y,test_size=0.3,
                                                               random_state=0)
...
#Prevendo com NaiveBayes
from sklearn.naive_bayes import GaussianNB

modelo = GaussianNB()
modelo.fit(X_treinamento2,Y_treinamento)
previsao = modelo.predict(X_teste2)
...
#-----------------------------------------------------------------------------
#Podemos ver que com o algoritmo NaiveBayes não conseguimos chegar ao resultado mínimo
#esperado de 75%.Sem seleção de atributos conseguimos uma taxa de acerto de 70,85%
#e selecionando os atributos essa taxa caiu para 70,71%.
